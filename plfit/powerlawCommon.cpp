...
namespace plfit
{
  ...
  void Powerlaw::SingleFit( const VectorType& V, VectorType& results, bool nosmall, bool finite, float startValue,
  ...
  void Powerlaw::BootstrapFit( const VectorType& V, VectorType& results, bool nosmall, bool finiteSize,
  ...
  void Powerlaw::GetIncrementVector( ValueType start, ValueType increment, ValueType end, VectorType& V )
  {
  ...
  void Powerlaw::MleInt( const VectorType& x, bool nosmall, bool finiteSize, ValueType startValue, ValueType increment,
  ...
  void Powerlaw::MleReal( const VectorType& x, bool nosmall, bool finiteSize, VectorType& results )
  {
    VectorType xmins;
    Unique( x, xmins );
    bool finiteSizeMessagePrinted = false;
  ...
  void Powerlaw::Bootstrap( const VectorType& inputs, bool nosmall, bool finiteSize, ValueType startValue,
